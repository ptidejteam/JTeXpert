...
public class TestingCrossover extends BreedingPipeline
    {
    ...
    public TestingCrossover() { parents = new TestCaseCandidate[2]; }
    ...
    public Object clone()
        {
        TestingCrossover c = (TestingCrossover)(super.clone());

        // deep-cloned stuff
        c.parents = (TestCaseCandidate[]) parents.clone();
        ...
        for(int q=start;q<n+start; /* no increment */)  // keep on going until we're filled up
            ...
            if (sources[0]==sources[1])  // grab from the same source
                ...
                if (!(sources[0] instanceof BreedingPipeline))  // it's a selection method probably
                    { 
                    parents[0] = (TestCaseCandidate)(parents[0].clone());
                    parents[1] = (TestCaseCandidate)(parents[1].clone());
                    }
                }
