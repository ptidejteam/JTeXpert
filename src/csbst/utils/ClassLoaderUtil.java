...
/**
 * Port of class loading methods from de>org.apache.commons.lang.ClassUtils</code> from
...
public class ClassLoaderUtil {
    ...
    public static Class getClass(ClassLoader classLoader, String className, boolean initialize)
         ...
         if (abbreviationMap.containsKey(className)) {
             ...
             clazz = Class.forName(toCanonicalName(className), initialize, classLoader).getComponentType();//, initialize, classLoader
         }
         else {
